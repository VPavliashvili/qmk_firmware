...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MN] = LAYOUT(
                 KC_PSCR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL ,
    ...
    [_SM] = LAYOUT(
                 ...
                 _______, XXXXXXX, XXXXXXX, KC_LBRC, KC_LCBR, XXXXXXX,                                     XXXXXXX, KC_RCBR, KC_RBRC, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, _______, KC_GRV , KC_BSLS, KC_PIPE, KC_TILD, XXXXXXX,                                     XXXXXXX, KC_EQL , KC_PLUS, KC_MINS, KC_UNDS, XXXXXXX, XXXXXXX,
    ...
    [_NM] = LAYOUT(
                 _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                 _______, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC,                                     KC_RPRN, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, XXXXXXX,
    ...
    [_FN] = LAYOUT(
                 ...
                 _______, KC_PGDN, KC_HOME, KC_END , KC_PGUP, XXXXXXX,                                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
